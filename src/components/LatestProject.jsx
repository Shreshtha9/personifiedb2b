...
const LatestProject = () => {
  ...
  return (
    <div className="bg-darkGreen min-h-screen w-full px-4 py-12 md:px-12 lg:px-24 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project) => (
            ...
            >
              ...
              {/* Removed line shape at bottom left inside card */}

              <div
                className={`absolute bottom-6 left-6  w-[45%] z-10 transition-all duration-300 rounded-lg ${
                  hoveredId === project.id ? "bg-[#F7D270]/10" : ""
                }`}
              >
